    ...
    <CardContent class="py-6">
      <div class="flex items-center justify-between">
        <div class="space-y-1">
          ...
          <p class="text-sm text-muted-foreground">Latest videos uploaded by users</p>
        </div>
          ...
          <Tabs
            ...
            <TabsContent
              ...
              <div class="flex items-center justify-between mt-4">
                <div class="space-y-1">
                  <h2 class="text-2xl font-semibold tracking-tight">Movie clips</h2>
                  <p class="text-sm text-muted-foreground">Lindy hop in movie scenes</p>
                </div>
              </div>
              <Separator class="my-4" />
              <div class="relative">
            ...
            <TabsContent
              ...
              <div class="flex items-center justify-between">
                <div class="space-y-1">
                  ...
                  <p class="text-sm text-muted-foreground">Videos of the classic strolls</p>
                </div>
              </div>
