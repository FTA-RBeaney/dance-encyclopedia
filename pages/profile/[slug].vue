...
<template>
  <main id="profile-form">
    ...
    <div class="grid grid-cols-1 px-4 xl:grid-cols-2 xl:gap-4">
      ...
      >
        <div class="flow-root">
          <h3 class="text-xl font-semibold dark:text-white">Your favourites</h3>
          <FavouritesDataTable
            v-if="favourites"
            :columns="columns"
            :data="favourites"
          ...
          />
          <p v-else>
            No favourites added yet. Come back when you've added some!
          </p>
        </div>
      </div>
      <div
      ...
      >
        <div class="flow-root">
          ...
          <div v-if="favourites" class="mt-4">
            <ul>
